...
def send_exception_by_str() -> str:
    ...
    try:
        ...
        print(
            e.__traceback__,
            type(e.__traceback__),
            hasattr(e.__traceback__, "__iter__"),
        )
...
def receive_exception(exc_obj):
    ...
    print(
        exc.__traceback__,
        type(exc.__traceback__),
        hasattr(exc.__traceback__, "__iter__"),
    )
    print(
        exc.__cause__, type(exc.__cause__), hasattr(exc.__cause__, "__iter__")
    )
